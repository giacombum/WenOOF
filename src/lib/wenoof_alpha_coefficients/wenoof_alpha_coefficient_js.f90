...
!< Jiang-Shu WENO alpha coefficient object.
!<
!< @note The provided WENO alpha coefficients implements the alpha coefficients defined in *Efficient Implementation of Weighted ENO
