...
type, extends(alpha_coefficient_z) :: alpha_coefficient_m
  ...
  contains
    ...
    procedure, pass(self), public :: compute     !< Return string-description of coefficients.
    procedure, nopass,     public :: description !< Compute coefficients.
    ! public methods
    procedure, pass(self), public :: initialize !< Initialize the base alpha coefficient function.
